...
#define HYUNDAI_COMMON_RX_CHECKS(legacy)                                                                                                                  \
  {.msg = {{0x260, 0, 8, .max_counter = 3U, .frequency = 100U, .ignore_quality_flag = true},                                                                                           \
           {0x371, 0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U, .ignore_quality_flag = true},                                                             \
           {0x91,  0, 8, .ignore_checksum = true, .ignore_counter = true, .frequency = 100U, .ignore_quality_flag = true}}},                                                           \
  {.msg = {{0x386, 0, 8, .ignore_checksum = (legacy), .ignore_counter = (legacy), .max_counter = (legacy) ? 0U : 15U, .frequency = 100U, .ignore_quality_flag = true}, { 0 }, { 0 }}}, \
  {.msg = {{0x394, 0, 8, .ignore_checksum = (legacy), .ignore_counter = (legacy), .max_counter = (legacy) ? 0U : 7U, .frequency = 100U, .ignore_quality_flag = true}, { 0 }, { 0 }}},  \

#define HYUNDAI_SCC12_ADDR_CHECK(scc_bus, ignore_checksum_)                                               \
  {.msg = {{0x421, (scc_bus), 8, .max_counter = 15U, .frequency = 50U, .ignore_checksum = (ignore_checksum_), .ignore_quality_flag = true}, { 0 }, { 0 }}}, \
...
static safety_config hyundai_init_carrot(bool legacy_car) {
    ...
    if (hyundai_camera_scc) {
        ...
        static RxCheck hyundai_long_rx_checks[] = {
          ...
          {.msg = {{0x4F1, 0, 4, .ignore_checksum = true, .max_counter = 15U, .frequency = 50U, .ignore_quality_flag = true}, { 0 }, { 0 }}
},
        };
