...
class HyundaiFlags(IntFlag):
  ...
  # If no points are outputted by default it might be possible to turn it on using iqdbc/lvbs/tools/ecu/hyundai_enable_radar_points.py
  MANDO_RADAR = 2 ** 12
  CANFD = 2 ** 13
...
class CAR(Platforms):
  ...
  HYUNDAI_AZERA_7TH_GEN = HyundaiCanFDPlatformConfig(
    [HyundaiCarDocs("Hyundai Azera 2023-24", "All", car_parts=CarParts.common([CarHarness.hyundai_a]))],
  ...
  HYUNDAI_IONIQ_5_PE = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Hyundai Ioniq 5 PE (without HDA II) 2024", car_parts=CarParts.common([CarHarness.hyundai_q])),
  ...
  HYUNDAI_IONIQ_9 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Hyundai Ioniq 9 2026", "All", car_parts=CarParts.common([CarHarness.hyundai_m])),
    ],
  ...
  HYUNDAI_CASPER_EV = HyundaiPlatformConfig(
    [HyundaiCarDocs("Hyundai Casper Electric 2024", "All", car_parts=CarParts.common([CarHarness.hyundai_k]))],
  ...
  HYUNDAI_PORTER_II_EV = HyundaiPlatformConfig(
    [HyundaiCarDocs("Hyundai Porter II Electric 2024", car_parts=CarParts.common([CarHarness.hyundai_h]))],
  ...
  HYUNDAI_SANTAFE_MX5 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Hyundai Santa Fe (MX5) 2024", car_parts=CarParts.common([CarHarness.hyundai_k])),
    ],
  ...
  HYUNDAI_SANTAFE_MX5_HEV = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Hyundai Santa Fe Hybrid (MX5) 2024", car_parts=CarParts.common([CarHarness.hyundai_k])),
    ],
  ...
  KIA_K5_DL3_24 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia K5 (South Korea only) 2024", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_k])),
    ],
    CarSpecs(mass=1553, wheelbase=2.85, steerRatio=13.27, tireStiffnessFactor=0.5),
  )
  KIA_K5_DL3_24_HEV = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia K5 Hybrid (South Korea only) 2024", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_k])),
    ],
    CarSpecs(mass=1553, wheelbase=2.85, steerRatio=13.27, tireStiffnessFactor=0.5),
  )
  ...
  KIA_EV6_PE = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia EV6 PE (without HDA II) 2025", car_parts=CarParts.common([CarHarness.hyundai_p])),
  ...
  GENESIS_GV70_EV_1ST_GEN = HyundaiCanFDPlatformConfig(
    [HyundaiCarDocs("Genesis GV70 Electrified (South Korea only) 2022-23", "All", car_parts=CarParts.common([CarHarness.hyundai_m]))],
  ...
  HYUNDAI_GRANDEUR_IG_HEV = HyundaiPlatformConfig(
    [HyundaiCarDocs("Hyundai Grandeur Hybrid 2018-19", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
    CarSpecs(mass=1570, wheelbase=2.845, steerRatio=16., tireStiffnessFactor=0.7),
    flags=HyundaiFlags.HYBRID | HyundaiFlags.LEGACY,
  )
  ...
  GENESIS_EQ900_L = HyundaiPlatformConfig(
    [HyundaiCarDocs("Genesis EQ900 Limousine 2016-18", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
    CarSpecs(mass=2290, wheelbase=3.45, steerRatio=16., tireStiffnessFactor=0.7),
    flags=HyundaiFlags.LEGACY,
  )
  GENESIS_G90_2019 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Genesis G90 (South Korea only) 2019", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
    CarSpecs(mass=2150, wheelbase=3.16, steerRatio=16., tireStiffnessFactor=0.7),
    flags=HyundaiFlags.LEGACY,
  )
  HYUNDAI_NEXO = HyundaiPlatformConfig(
    [HyundaiCarDocs("Hyundai Nexo (South Korea only) 2018-20", "All", car_parts=CarParts.common([CarHarness.hyundai_a]))],
  ...
  KIA_K5 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K5 2016, 2019", "All", car_parts=CarParts.common([CarHarness.hyundai_b]))],
  ...
  KIA_K5_HEV_2022 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K5 Hybrid (South Korea only) 2022", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
    CarSpecs(mass=1515, wheelbase=2.85, steerRatio=15.5, tireStiffnessFactor=0.7),
    flags=HyundaiFlags.HYBRID | HyundaiFlags.LEGACY,
  )
  KIA_K7 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K7 2016-19", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
    CarSpecs(mass=1850, wheelbase=2.855, steerRatio=15.5, tireStiffnessFactor=0.7),
    flags=HyundaiFlags.LEGACY | HyundaiFlags.CLUSTER_GEARS,
  )
  KIA_K7_HEV = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K7 Hybrid 2016-19", "All", car_parts=CarParts.common([CarHarness.hyundai_c]))],
  ...
  KIA_K9 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia K9 2016-19", "All", car_parts=CarParts.common([CarHarness.hyundai_h]))],
  ...
  KIA_EV9 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia EV9 (MV) 2024", car_parts=CarParts.common([CarHarness.hyundai_k])),
    ],
  ...
  KIA_EV3 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia EV3 (SV1) 2025", car_parts=CarParts.common([CarHarness.hyundai_n])),
    ],
  ...
  KIA_PV5 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Kia PV5 (SW1) 2025", car_parts=CarParts.common([CarHarness.hyundai_n])),
    ],
